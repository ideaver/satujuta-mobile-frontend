...
import '../../molecule/student_registration/form_student_registration.dart';
...
class _SRFormState extends State<SRForm> {
                  ...
                  onPressed: () {
                    ModalBottom.modalBottom(
                      ...
                      contentModalBottom(
                        context,
                        "Kecamatan",
                        ["Tambak Sari", "Lidah Wetan", "Kaliasin", "Benowo", "Tambak boyo"],
                      ),
                    );
                  },
                ),
  ...
  ListView contentSuccessModalBottom(BuildContext context, String title, String description) {
    return ListView(children: [
      Container(
        decoration: const BoxDecoration(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      children: [
                        CircleAvatar(child: Image.asset(AppAssets.darkEditIconPath)),
                        CircleAvatar(child: Image.asset(AppAssets.trashIconPath))
                      ],
                    )),
                    // Expanded(
                    //     flex: 2,
