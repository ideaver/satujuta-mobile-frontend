...
import 'package:satujuta_app_mobile/view/checkout/student_checkout_view.dart';
...
class RegisStudentStatus extends StatefulWidget {
  RegisStudentStatus({
  ...
  @override
  State<RegisStudentStatus> createState() => _RegisStudentStatusState();
}

class _RegisStudentStatusState extends State<RegisStudentStatus> {
  bool isShow = true;
  int a = 3;
  @override
