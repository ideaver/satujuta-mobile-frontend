...
Widget wrapListQuestion() {
  return const AppExpansionListTile(
    ...
    children: [
      ...
      QuestionCard(
        titleQuestion:
            'Apa Yang Akan Saya Dapatkan Kalau Bergabung Dengan Komunitas SatuJuta?',
        question:
            'Lorem ipsum dolor sit amet consectetur. Ipsum in ornare vestibulum sit et ipsum euismod integer sem. In sed turpis arcu est nulla rutrum tortor. Dignissim at vel.',
      ),
      SizedBox(height: AppSizes.height / 3),
          ...
          MyTextLine(
            title: MyCustomText(
              ...
              style: AppTextStyle.bold(context,
                  color: AppColors.base, fontSize: 20),
            ),
            gap: 8,
            subTitle: MyCustomText(
              text: 'Lorem ipsum dolor sit amet, consectetur',
              style: AppTextStyle.regular(context,
                  color: AppColors.baseLv5, fontSize: 14),
            ),
          ),
          const MySeparated(sizeWidth: 0, sizeHeight: 8),
          Padding(
